...
public class CvManager implements CvService {
    ...
    public Result add(int candidateId) {
        Cv cv = new Cv();
        cv.setCandidate(this.candidateDao.findById(candidateId).orElseThrow());
    ...
    public DataResult<Cv> getByCvId(int cvId) {
        ...
        return new SuccessDataResult<Cv>(this.cvDao.findById(cvId).orElseThrow(), "Data listelendi");
    }
    ...
    public Result updateGithub(String githublink, int cvId) {
        ...
        Cv cv = this.cvDao.findById(cvId).orElseThrow();
