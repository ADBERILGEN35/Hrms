...
public class GFCExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(GFCDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new GFCStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static GFCDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static GFCDateTimeConverter dateTimeConverter = new GFCStandardDateTimeConverter();

    public GFCExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public GFCExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new GFCMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=GFCHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,GFCExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=GFCHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
