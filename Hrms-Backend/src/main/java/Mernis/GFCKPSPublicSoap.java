...
public class GFCKPSPublicSoap
{
    ...
    public GFCKPSPublicSoap(){}

    public GFCKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public GFCKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        GFCExtendedSoapSerializationEnvelope envelope= new GFCExtendedSoapSerializationEnvelope(GFCExtendedSoapSerializationEnvelope.VER11);
